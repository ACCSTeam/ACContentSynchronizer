namespace ACContentSynchronizer {
  public static class Routes {
    public const string CancelPack = "cancelPack";
    public const string DownloadContent = "downloadContent";
    public const string GetManifest = "getManifest";
    public const string GetUpdateManifest = "getUpdateManifest";
    public const string PackContent = "packContent";
